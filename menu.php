...
<li><a href=" ######### ">billing</a>
    <ul>
   <li><a href="billing.php">Add billing</a></li>
        <li><a href="viewbilling.php">View billing Records</a></li>
    </ul>
</li>
...
<a href=" ######### ">Settings</a>
    <ul>
        ...
        <li><a href="orders.php" style="width:150px;">Add Orders</a></li>
        <li><a href="vieworder.php" style="width:150px;">View Orders</a></li>
